...
<div class="container-fluid">
	<form id="inform" action ="/board/write2.do" method="post" onsubmit="return writeCheck2();">
		<table class="table table-striped table-bordered table-hover" style="text-align:center;">
			...
			<tr>
				<th><textarea name="license_num" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="license_grade" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="license_date" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="license_agency" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
			</tr>
		...
		<table class="table table-striped table-bordered table-hover" style="text-align:center;">
			...
			<tr>
				<th><textarea name="in_name" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="in_period" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="in_grade" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="in_activity" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
			</tr>
			<tr>
				<th colspan="5"></th>
			</tr>
			...
			<tr>
				<th><textarea name="out_name" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="out_period" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="out_grade" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="out_activity" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
			</tr>
			<tr>
				<th style="text-align:center">기타사항</th>
				<th colspan="4"><textarea size="100" name="etc" rows="5" cols="130" placeholder="내용을 입력하세요" form="inform"></textarea></th>
			</tr>
		</table>
		<table class="table table-striped table-bordered table-hover" style="text-align:center;">
			...
			<tr>
				<th><textarea name="test_name" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="test_date" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="test_agency" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="test_grade" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
				<th><textarea name="test_score" rows="5" cols="20" placeholder="내용을 입력하세요" form="inform"></textarea></th>
			</tr>
			<hr />
			<tr>
